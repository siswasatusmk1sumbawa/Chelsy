...
<body>
    ...
    <main class="flex-shrink-0">
      <div class="container text-white">
        <h1 class="mt-4 mb-4">Welcome <?= $_SESSION['namalengkap'] ?> ! </h1>
        ...
        <div class="row justify-content-center">
          ...
          ?>
          <div class="col-sm-3 my-1 me-2 ms-2">
            <div class="card">
              ...
              <div class="card-footer">
                ...
                ?>
                <a href="admin.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-danger">love (<?= mysqli_num_rows($sql2) ?>)</button></a>
                <a href="komentar.php?fotoid=<?= $data['fotoid'] ?>"><button type="button" class="btn btn-warning">comment (<?= mysqli_num_rows($sql3) ?>)</button></a>
              </div>
        </div>
      </div>
          <?php
